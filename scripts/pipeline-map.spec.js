...
module.exports = {
  constants: [
    ...
    { name: 'LLM_COST', file: 'supabase/functions/api/index.ts', object: true },
  ...
  nodes: {
    ...
    'sv.llm':     { diagram: 'server', group: 'actions', kind: 'credit', label: 'llm — {LLM_COST.pro} pro / {LLM_COST.flash} flash',
